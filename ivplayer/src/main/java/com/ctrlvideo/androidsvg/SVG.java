...
public class SVG {
    ...
    public static SVG getFromFile(Context context, String filename) throws SVGParseException, IOException {
        SVGParser parser = new SVGParser();
...
//        InputStream is = context.openFileInput(filename);
    ...
    public float getDocumentAspectRatio() {
        ...
        // If width and height are both specified and are not percentages, aspect ratio is calculated from these
        // (SVG1.1 sect 7.12)
        ...
        if (this.rootElement.viewBox != null && this.rootElement.viewBox.width != 0f && this.rootElement.viewBox
                .height != 0f) {
    ...
    protected static class SvgElementBase extends SvgObject {
        ...
        public Style        baseStyle     = null;   // style defined by explicit style attributes in the element (eg.
        // fill="black")
        public Style        style         = null;       // style expressed in a 'style' attribute (eg.
        // style="fill:black")
