...
//    private VideoProtocolInfo.EventComponent eventComponent;
    ...
    public void setOnOptionRepeatClickListener(OnOptionRepeatClickListener listener) {
    ...
    private OnOptionRepeatClickListener listener;
    private OnComponentResultListener showResultListener;

    public interface OnOptionRepeatClickListener {
        void onOptionRepeatClick(int option);
    }
...
//                    Log.d(TAG, "click_num=" + eventComponent.click_num);
                    ...
                    if (clickCount >= eventComponent.click_num) {
                        ...
                        if (listener != null) {
                            listener.onOptionRepeatClick(finalI);
                        }
                    } else {
                        if (handler != null) {
